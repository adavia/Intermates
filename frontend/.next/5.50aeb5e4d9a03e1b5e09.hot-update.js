...
function (_Component) {
  ...
  _createClass(Pagination, [{
    ...
    value: function componentDidMount() {
      console.log(this.props.pageNumber); // if (this.props.pageNumber !== prevProps.pageNumber) {
      //   this.gotoPage(this.props.pageNumber)
      // }
    }
  }, {
    key: "render",
...
//# sourceMappingURL=5.50aeb5e4d9a03e1b5e09.hot-update.js.map