...
})(["display:inline-block;cursor:pointer;font-weight:", ";&:hover{font-weight:900;}"], function (props) {
...
function (_Component) {
  ...
  function Pagination(props) {
    ...
    _this.totalPages = Math.ceil(_this.totalRecords / _this.pageLimit); //console.log(props.pageNumber)
  ...
  _createClass(Pagination, [{
    ...
    value: function getDerivedStateFromProps(props, state) {
      console.log(props, state); // // Any time the current user changes,
...
//# sourceMappingURL=5.27262ec986e9d69b4f3b.hot-update.js.map