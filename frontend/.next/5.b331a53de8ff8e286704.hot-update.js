...
function (_Component) {
  ...
  _createClass(Pagination, [{
    ...
    value: function componentDidUpdate(prevProps) {
      console.log(prevProps.pageNumber, this.props.pageNumber, this.state.currentPage); // if (this.props.pageNumber === this.state.currentPage) {
...
//# sourceMappingURL=5.b331a53de8ff8e286704.hot-update.js.map